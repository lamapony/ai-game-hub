...
function impostorState(overrides: Partial<ImpostorState> = {}): ImpostorState {
  return {
    ...
    usedQuestionIds: ["q1"],
    questionId: "q1",
    question: "Worst toast?",
    answers: { p1: "to taxes", p2: "to us", p3: "to Monday" },
    shuffled: [
      { id: "a1", playerId: "p1", text: "to taxes" },
      { id: "a2", playerId: "p2", text: "to us" },
      { id: "a3", playerId: "p3", text: "to Monday" },
      { id: "ai", text: "to stability" },
    ],
    aiAnswerId: "ai",
    votes: {},
    ...overrides,
